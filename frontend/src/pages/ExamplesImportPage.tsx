  ...
  return (
    <div className="p-4 sm:p-8 max-w-5xl mx-auto">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">
        ...
        <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">figures/</code> subdirectory. Use the
      ...
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-5 mb-4 space-y-4">
        <div>
          <label htmlFor="batch-zip" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
            Batch zip
          </label>
          <input
            id="batch-zip"
