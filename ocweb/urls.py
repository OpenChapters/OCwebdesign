...
from catalog.views import (
    ...
    ExampleAuthorImportCommitView,
    ExampleAuthorImportDryRunView,
    ExampleAuthorManageView,
    ExampleFigureDeleteView,
    ExampleFigureFileView,
    ExampleFigureUploadView,
    ExampleMineView,
    ExamplePreviewPdfView,
    ExamplePreviewTriggerView,
...
urlpatterns = [
    ...
    path("api/chapters/catalog.csv", ChapterCatalogCsvView.as_view(), name="chapter-catalog-csv"),
    path("api/chapters/search/", ChapterSearchView.as_view(), name="chapter-search"),
    ...
    path("api/examples/<int:pk>/figures/", ExampleFigureUploadView.as_view(), name="example-figure-upload"),
    ...
    path("api/examples/import/dry-run/", ExampleAuthorImportDryRunView.as_view(), name="example-author-import-dry-run"),
    path("api/examples/import/commit/", ExampleAuthorImportCommitView.as_view(), name="example-author-import-commit"),
