...
This project consists of a web application for building on-demand, open-source PDF/HTML textbooks from LaTeX source chapters. Authors contribute chapters under the [Creative Commons CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) license, and maintain their own chapter(s) using a central GitHub repository. Course instructors who wish to configure their own custom textbook can browse the catalog, assemble custom books, and receive professionally typeset PDFs or a zip file with a complete web site.
...
4. **Download** — completed PDFs and/or HTML zip files appear in your personal library and will persist there long term; the Build data is stored and a user can return to a book at any point, modify it, and re-build it

Chapters and figures live in the [OpenChapters/OpenChapters](https://github.com/OpenChapters/OpenChapters) monorepo on GitHub. The chapter catalog is synced nightly so that the latest version of all chapters is always available in the OpenChapters user interface.
...
5. **Update** your chapter on a regular basis and submit a pull request for each major update
...
The web platform code in this repository is licensed under the [BSD 3-Clause License](https://github.com/OpenChapters/OCwebdesign/blob/main/LICENSE).
