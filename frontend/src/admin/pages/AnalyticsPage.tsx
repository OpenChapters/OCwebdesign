  ...
  return (
    <div className="p-8 max-w-6xl">
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">Builds per day (last 30 days)</h2>
        {builds.length === 0 ? (
          <p className="text-sm text-gray-400 dark:text-gray-500">No build data yet.</p>
        ) : (
      ...
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">Most included chapters</h2>
        {chapters.length === 0 ? (
      ...
      {/* User registrations */}
      <section className="mb-10">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3">User registrations (last 90 days)</h2>
        {users.length === 0 ? (
          <p className="text-sm text-gray-400 dark:text-gray-500">No registration data yet.</p>
        ) : (
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <ResponsiveContainer width="100%" height={250}>
