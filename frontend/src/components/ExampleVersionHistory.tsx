        ...
        <div className="px-3 pb-3 pt-1 space-y-3 text-sm">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs">
            ...
            {v.snapshot.primary_chapter_chabbr && (
              <span className="font-mono px-2 py-0.5 rounded bg-gray-100 text-gray-700">
                {v.snapshot.primary_chapter_chabbr}
            ...
            {v.snapshot.chapters_chabbrs
              ...
              .map((c) => (
                <span
                  key={c}
                  className="font-mono px-2 py-0.5 rounded bg-gray-100 text-gray-700"
                >
                  {c}
                </span>
              ))}
          ...
          <div>
            ...
            <MathText
              ...
              className="text-sm bg-gray-50 border border-gray-200 rounded-md p-3"
            />
          </div>
          <div>
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">
